...
##================================
def do_shift_scale_crop( image, x0=0, y0=0, x1=1, y1=1 ):
...
def do_random_shift_scale_crop_pad2(image, limit=0.10):
    ...
    #y0, y1, x0, x1
    image = do_shift_scale_crop( image, x0, y0, x1, y1 )
    return image

def do_shift_scale_rotate2( image, dx=0, dy=0, scale=1, angle=10):
